...
let questions = [
  new Question("Who is the creator of PHP?", ["Jack Sparrow", "Rasmus Lerdorf", "Tim Berners-Lee", "Dennis Ritchie"], "Rasmus Lerdorf"),
  ...
  new Question("What does PHP mean today ?", ["PHP: Personal Home Page","PHP: Program High Performace", "PHP: Hypertext Preprocessor", "PHP: Hypertext Page"], "PHP: Hypertext Preprocessor"),
